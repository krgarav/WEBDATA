      ...
      <div className="relative w-full h-screen">
        ...
        {showEditModel && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
            <div className="bg-white rounded-lg shadow-lg w-[30%] relative">
              <EditModel
        ...
        {showFinalComponent && (
          <div className="fixed inset-0 flex justify-center items-center z-50">
            <div className="bg-white rounded-lg shadow-lg w-full relative">
              <FinalComponent setShowFinalComponent={setShowFinalComponent} />
            </div>
          </div>
        )}
      </div>
...
const FirstComponent = ({ setShowFirstComponent, setShowEditModel }) => {
  return (
                      ...
                      <div className="relative">
                        <div className="inline-flex items-center overflow-hidden rounded-2xl border bg-white">
                          <button
                            ...
                            onClick={() => {
                              setShowFirstComponent(false); // Close FirstComponent
                              setShowEditModel(true); // Open EditModel
                            }}
                          >
                            View
                          </button>
...
const EditModel = ({ setShowFinalComponent, setShowEditModel }) => {
  return (
                    ...
                    <div className="flex">
                      ...
                      <div className="text-center py-4 whitespace-nowrap text-sm text-gray-500 w-1/4">
                        <button
                          ...
                          onClick={() => setShowFinalComponent(true)}
                        >
                          Edit
                        </button>
                      </div>
...
const FinalComponent = ({ setShowFinalComponent }) => {
  return (
    <>
    <Navbar/>
      <div className="w-[100%] pt-20 h-[100vh] bg-blue-500 lg:flex gap-10 xl:gap-80 px-5">
          ...
          <div className="flex  justify-around pb-3 lg:pb-5  px-4 lg:px-7 lg:w-full">
            <button class="group inline-block rounded-3xl bg-blue-500 p-[2px] text-white hover:bg-indigo-600 focus:outline-none focus:ring active:text-opacity-75">
              <span
                ...
                onClick={() => setShowFinalComponent(false)}
              >
                Back
              </span>
            </button>
